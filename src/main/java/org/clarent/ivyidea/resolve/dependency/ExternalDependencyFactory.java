...
public class ExternalDependencyFactory {
    ...
    @Nullable
    public ExternalDependency createExternalDependency(@NotNull Project project, @NotNull Artifact artifact, @Nullable File file, @Nullable DependencyScope dependencyScope) {
