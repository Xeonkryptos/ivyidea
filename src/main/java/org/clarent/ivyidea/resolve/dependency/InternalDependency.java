...
public class InternalDependency implements ResolvedDependency {
    ...
    public void addTo(IntellijModuleWrapper intellijModuleWrapper) {
        if (!intellijModuleWrapper.alreadyHasDependencyOnModule(module)) {
            ...
            intellijModuleWrapper.addModuleDependency(module, dependencyScope);
        } else {
            ...
            intellijModuleWrapper.updateModuleDependencyScope(module, dependencyScope);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof InternalDependency)) return false;
